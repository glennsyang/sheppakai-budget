      ...
      <main className="leading-normal tracking-normal text-white gradient">
            ...
            <div className="flex flex-wrap">
              <div className="w-5/6 sm:w-1/2 p-6">
                ...
                <p className="text-gray-600 mb-8">
                  With Sheppakaibudget, Dave and Sarah craft a budget that reflects their values. They set aside what they need each month, and choose how to use the rest based on what's important to them.
                </p>
              </div>
            ...
            <div className="flex flex-wrap flex-col-reverse sm:flex-row">
              ...
              <div className="w-full sm:w-1/2 p-6 mt-6">
                <div className="align-middle">
                  ...
                  <p className="text-gray-600 mb-8">
                    With a budget that syncs between his mobile devices and the web, Dave and his wife Sarah are always on the same page with their spending.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="container mx-auto text-center py-6">
          ...
          <h3 className="my-4 text-3xl leading-tight">
            Replace your family budget planner, worksheet or spreadsheet with software that works!
          </h3>
          <Link href="/signup"><a>
            <button className="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
              Sign Up!
